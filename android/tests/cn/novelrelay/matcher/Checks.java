...
public final class Checks extends Instrumentation {
    ...
    @Override public void onStart(){Bundle result=new Bundle();try{
        ...
        Thread.sleep(1800);shot("android-save-picker.png");sendKeyDownUpSync(KeyEvent.KEYCODE_BACK);waitJS("document.getElementById('message').textContent.includes('取消')");check(true,"save cancellation returns to usable form");
